...
ExamJs::ExamJs(QWidget*parent):QDialog(parent)
{
    QFont font;
...
ExamJs::ExamJs(int m,int n,QWidget*parent):
    QDialog(parent)
{
    num=n;
    dayornight=m;
