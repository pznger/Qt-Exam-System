...
notimeExamDialog::notimeExamDialog(QWidget*parent):QDialog(parent)
{
    QFont font;
...
void notimeExamDialog::initLayout()
{
...
bool notimeExamDialog::initTextEdit()
{
    QString strline;//保存文件读取的数据
    QStringList strlist;//保存文件读取的答案
    QString xxx=QString::number(16);
...
void notimeExamDialog::initButtons()
{
...
bool notimeExamDialog::hasNoSelect()
{
    int radioSelects=0;
    for(int i=0;i<8;i++)
    {
...
void notimeExamDialog::getScore()
{
    if(hasNoSelect())
    {
