...
ExamDx::ExamDx(QWidget*parent):QDialog(parent)
{
    QFont font;
...
ExamDx::ExamDx(int m,int n,QWidget*parent):
    QDialog(parent)
{
    num=n;
    dayornight=m;
