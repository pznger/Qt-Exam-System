...
#include <QSet>
#include <QList>
ExamDu::ExamDu(QWidget*parent):QDialog(parent)
{
    QFont font;
...
ExamDu::ExamDu(int m,int n, QWidget *parent):QDialog(parent)
{
    num=n;
    dayornight=m;
    QFont font;
    ...
    if(!dayornight)setPalette(QPalette(QColor(209,250,255)));
...
void ExamDu::initUI()
{
    ...
    {
        QMessageBox::information(this,"提示","多选题只有10套题");
        return;
    }
